...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_516b6e386f46e',
  'has_nocache_code' => false,
  'cache_lifetime' => 1,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_516b6e386f46e')) {function content_516b6e386f46e($_smarty_tpl) {?>  <!--
	...
	<body>
		...
		<div id="main-wrapper-setup">
			<div id="navi" style="float: right; font-size: 14pt; font-family: "Helvetica Neue",Helvetica,Arial,sans-serif">
				<a href="http://localhost/ade/"><i class="icon-home"> Back to Home</i></a>
			</div>
			<br>
			<br>
		...
		<script src="http://localhost/ade/assets/scripts/bootstrap.min.js" type="text/javascript"></script><?php }} ?>