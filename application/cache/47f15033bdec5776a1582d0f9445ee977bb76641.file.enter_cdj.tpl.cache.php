<?php /* Smarty version Smarty-3.1.7, created on 2013-04-15 16:44:05
         compiled from "C:\xampp\htdocs\ade\application/views\edit\enter_cdj.tpl" */ ?>
...
<?php if ($_valid && !is_callable('content_5167be09c4a71')) {function content_5167be09c4a71($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'C:\\xampp\\htdocs\\ade\\application\\libraries\\smarty\\plugins\\function.url.php';
?><!--
...
" placeholder="ex: ST-1-2010" onChange="expAcctOnChange(this.id); return false;"></div></div></div></td><td><div class="table-column" id="group-purchases<?php echo $_smarty_tpl->tpl_vars['rowNo']->value;?>
"><div id="control-purchases<?php echo $_smarty_tpl->tpl_vars['rowNo']->value;?>
" class="control" style="text-align: center"><input type="text" style="width: 80px" id="purchases<?php echo $_smarty_tpl->tpl_vars['rowNo']->value;?>
" name="purchases[]" value="<?php echo $_smarty_tpl->tpl_vars['e']->value['main_debit'];?>
...
" placeholder="Php 0.00" onChange="expAcctOnChange(this.id); return false;"></div></div></div></td><td><div class="table-column"><div class="control" style="text-align: center"><input type="text" style="width: 80px" id="cash<?php echo $_smarty_tpl->tpl_vars['rowNo']->value;?>
" name="cash[]" value="<?php echo $_smarty_tpl->tpl_vars['e']->value['main_credit'];?>
...
?>
										<?php if (($_smarty_tpl->tpl_vars['e']->value['ref']=='Total')){?>
											<tr>
												...
												<td>
													<input type="text" class="span2" id="total_purchases" name="total_purchases"  style="width: 80px" value="<?php echo $_smarty_tpl->tpl_vars['e']->value['main_debit'];?>
...
" placeholder="Php 0.00"/>
												...
												<td>
													<input type="text" class="span2" id="total_cash" name="total_cash"  style="width: 80px" value="<?php echo $_smarty_tpl->tpl_vars['e']->value['main_credit'];?>
" placeholder="Php 0.00"/>
												</td>
