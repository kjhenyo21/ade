...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5165b4191759c',
  'has_nocache_code' => false,
  'cache_lifetime' => 1,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5165b4191759c')) {function content_5165b4191759c($_smarty_tpl) {?>  <!--
...
-->
	...
	<body>
			...
			<div id="summary-container" style="height: 300px; margin: 0 auto; text-align: center">
				...
				<div class="sub-summary-container">
					...
					<div class="sub-summary-container">
						...
						<div>Desc.: 6270-6279</div>
						<div>Amount: Php 4,819.00</div>
					</div>
													<div class="arrow">
						<img src="http://localhost/trailblazer/assets/images/arrow-left-small.PNG"></img>
					</div>
					<div class="sub-summary-container">
							...
							<div>OR No.: <a href="#trans-details6270" data-toggle="modal" onClick="getDetails('or_no=6270&amt=360&name=&address=&contact='); return false;">6270</a></div>
							<div>Amount: Php 360.00</div>
							<div>Name: </div>
							<div>Contact: </div>
											</div>
											</div>
		...
		<div class="control-group" style="text-align: center; margin-top: 15px;">
			...
			<a href="http://localhost/trailblazer/audit_trail/index/readFile?file=is-1-2010.is&doc=Income%20Statement&items=undefined" type="button" class="btn">Back to First Step</a>
		</div>
