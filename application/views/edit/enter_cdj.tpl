									...
									{foreach $entries as $e}
										{if ($e['ref'] == 'Total')}
											<tr>
												...
												<td>
													<input type="text" class="span2" id="total_purchases" name="total_purchases"  style="width: 80px" value="{$e['main_debit']}" placeholder="Php 0.00"/>
												</td>
												<td>
													<input type="text" class="span2" id="total_other" name="total_other" style="width: 80px" value="{$e['other']}" placeholder="Php 0.00"/>
												</td>
												<td>
													<input type="text" class="span2" id="total_cash" name="total_cash"  style="width: 80px" value="{$e['main_credit']}" placeholder="Php 0.00"/>
												</td>
